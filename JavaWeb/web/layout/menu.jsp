            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="/JavaWeb/producao/producao.jsp">
                                <i class="fas fa-chart-bar"></i>PRODUÇÂO</a>
                        </li>
                        <li>
                            <a href="/JavaWeb/equipe/equipe.jsp">
                                <i class="fas fa-table"></i>EQUIPES</a>
                        </li>
                        <li>
                            <a href="/JavaWeb/veiculo/veiculo.jsp">
                                <i class="far fa-check-square"></i>VEÍCULOS</a>
                        </li>=-
                            <a class="js-arrow" href="#">
                                <i class="fas fa-desktop"></i>RELATÓRIO</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="/JavaWeb/button.html">Placas</a>
                                </li>
                                <li>
                                    <a href="/JavaWeb/badge.html">Pintura</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
